...
- *(Core ten paired; **Arc One closed at Ep18**. The run now follows the **[50-episode menu](../EPISODE_IDEAS_50.md)** and **[STORYBOARD_AND_ARCS.md](../STORYBOARD_AND_ARCS.md)**. **NEXT: the ★ Five More Forced Predictions** arc — see [EPISODE_IDEAS_50.md](../EPISODE_IDEAS_50.md) PRIORITY BLOCK (FP3 resonances pairs Ep15's flux tube; FP4 dark relic; FP5 end-of-elements Z=137; FP1 new-particle scale; FP2 neutrinos).)*
