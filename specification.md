...
This document defines the mathematical foundations and core operations of the **Smithian Fold Theory of Everything**. The theory models the universe and mathematical space not as a collection of static points, but as a system of active folds starting from a single unit of action.
